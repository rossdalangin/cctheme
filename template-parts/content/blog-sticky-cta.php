...
<div class="sticky-blog-cta">
	<div class="sticky-cta-content">
		...
		<a href="<?php echo esc_url( get_theme_mod( 'closeclient_sticky_cta_link', '#' ) ); ?>" class="button button-accent"><?php echo esc_html( get_theme_mod( 'closeclient_sticky_cta_button', 'Join the Newsletter' ) ); ?></a>
	</div>
</div>
