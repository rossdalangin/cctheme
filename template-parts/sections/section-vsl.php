...
<section class="section section-lg section-vsl reveal overflow-hidden">
    ...
    <div class="container container-narrow text-center">
        ...
        <h2 class="section-headline gradient-text reveal"><?php echo esc_html( get_theme_mod( 'closeclient_vsl_headline', 'The Big Domino: Why Your Expert Business is Stalled (And The Precise Mechanism to Fix It)' ) ); ?></h2>
        ...
        <?php
        $takeaways = get_theme_mod( 'closeclient_vsl_takeaways', 'The hidden bottlenecks of $10k months, The precise architecture of omnipresence, Engineering a frictionless sales engine' );
        if ( $takeaways ) : ?>
