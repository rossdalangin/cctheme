...
<section class="section section-booking-cta text-center">
    <div class="container container-narrow">
        ...
        <div class="booking-button-wrapper" style="margin: 3rem 0;">
            <a href="<?php echo esc_url( get_theme_mod( 'closeclient_booking_link', '#' ) ); ?>" class="button button-large button-accent"><?php echo esc_html( get_theme_mod( 'closeclient_booking_text', 'Book Your Scaling Audit' ) ); ?></a>
        </div>
