...
function closeclient_reset_defaults() {
    $defaults = array(
        ...
        'closeclient_modal_tag'        => 'STRATEGY FIRST',
        'closeclient_modal_headline'   => 'Request Your Authority Audit',
        'closeclient_modal_text'       => 'Submit your details and we’ll tailor an audit and proposal based on your exact objectives.',
        'closeclient_404_tag'          => '404 ERROR',
        'closeclient_404_headline'     => 'That page can’t be found.',
        'closeclient_404_text'         => 'It looks like nothing was found at this location. Maybe try a search or head back to the growth hub?',
        'closeclient_404_cta'          => 'Back to Growth Hub',
        'closeclient_portfolio_archive_tag'      => 'CASE STUDIES',
        'closeclient_portfolio_archive_headline' => 'Engineered Success Stories',
        'closeclient_portfolio_archive_text'     => 'Deep dives into how we transform expert knowledge into high-performance authority machines.',
        'closeclient_service_archive_tag'        => 'OUR CAPABILITIES',
        'closeclient_service_archive_headline'   => 'Strategic Systems',
        'closeclient_sales_tag_tpl'              => 'EXCLUSIVE OFFER',
        'closeclient_sales_cta_tpl'              => 'Yes! Build My Machine →',
        'closeclient_sales_stack_title_tpl'      => 'The Authority Ecosystem',
        'closeclient_sales_stack_text_tpl'       => 'Everything you need to command the market.',
        'closeclient_contact_tag_tpl'          => 'GET IN TOUCH',
        'closeclient_contact_direct_title_tpl' => 'Direct Contact',
        'closeclient_contact_direct_text_tpl'  => 'Prefer email? Reach out at:',
        'closeclient_thankyou_wait_title_tpl'  => 'While You Wait...',
        'closeclient_about_tag_tpl'            => 'OUR MISSION',
        'closeclient_leadmagnet_tag_tpl'       => 'FREE TRAINING',
        'closeclient_footer_cta_text'          => 'Ready to engineer your authority?',
        'closeclient_footer_privacy_text'      => 'Privacy Policy',
        'closeclient_footer_tos_text'          => 'Terms of Service',
        'closeclient_footer_back_top_text'     => 'BACK TO TOP ↑',
